...
public class StockTransferRpcService implements IStockTransferRpcService {
    ...
    public boolean checkLocation(BaseinfoLocation fromLication, BaseinfoLocation toLication) throws BizCheckedException {
        BaseinfoLocation fromFationLocation = locationService.getFatherRegionByClassfication(fromLication.getLocationId(),1);
        BaseinfoLocation toFationLocation = locationService.getFatherRegionByClassfication(toLication.getLocationId(),1);
    ...
    public boolean checkPlan(StockTransferPlan plan) throws BizCheckedException {
        ...
        if (!this.checkLocation(fromLocation, toLocation)) {
            throw new BizCheckedException("2550037");
        }
        if (plan.getSubType().equals(1L)) {
            throw new BizCheckedException("2550040");
        }
        BaseinfoLocation fromFationLocation = locationService.getFatherRegionByClassfication(fromLocation.getLocationId(),1);
        ...
        BaseinfoLocation toFationLocation = locationService.getFatherRegionByClassfication(toLocation.getLocationId(), 1);
