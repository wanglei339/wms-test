...
public class ReceiptTaskHandler extends AbsTaskHandler {
    ...
    public void postConstruct() {
        handlerFactory.register(TaskConstant.TYPE_RECEIPT, this);
    }

    protected void getConcrete(TaskEntry taskEntry) {
        taskEntry.setTaskHead(poReceiptService.getInbReceiptHeaderByReceiptId(taskEntry.getTaskInfo().getOrderId()));
        taskEntry.setTaskDetailList((List<Object>)(List<?>)poReceiptService.getInbReceiptDetailListByReceiptId(taskEntry.getTaskInfo().getOrderId()));
    }
