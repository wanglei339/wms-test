...
public class RouteLoader {
    private static Logger logger = LoggerFactory.getLogger(RouteLoader.class);
    ...
    private void refreshRoute() throws BizCheckedException {
        //System.out.println("xxxxxxxx===========yyyyyyyyyyy");
    }
