define(function (require, exports, module) {
    ...
    var ModelEdit = function () {
        this.el_content_edit = "#content_mod_edit";
        this.el_div_edit = "#div_mod_edit";
        this.el_form = "#form_mod";
        this.el_btn_save = "#btn_mod_save";
        this.el_btn_back = "#btn_mod_back";
    }

    ModelEdit.prototype.init = function () {
        this.show();
        this.loadContent();
    }

    ModelEdit.prototype.setOptions = function (options) {
        this.options = $.extend(this.options, options);
    }

    ModelEdit.prototype.show = function () {
        $('div[data-sign="content"]').hide();
        $(this.el_content_edit).show();
    }

    ModelEdit.prototype.loadContent = function () {
        var that = this;
        var url = App.ctx + "/up/mod/page/edit" + " " + this.el_form;
    ...
    ModelEdit.prototype.loadContentFinish = function () {
        // 初始化事件
        this.initEvents();
        // 初始化校验组件
        this.initValidate();
    ...
    ModelEdit.prototype.initEvents = function () {
        var that = this;
    ...
    ModelEdit.prototype.initValidate = function () {
        this.validate = $(this.el_form).validate({
            ...
            messages: {
                modCode: {required: "型号编码必填！"},
                modName: {required: "型号名称必填！"}
            },
    ...
    ModelEdit.prototype.getFormData = function () {
        var data = {};
    ...
    ModelEdit.prototype.btnSave = function () {
